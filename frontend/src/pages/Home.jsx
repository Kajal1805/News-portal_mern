import Advertise from '@/components/SharedComponent/Advertise'
  ...
  return (
    <div>
      <div className='flex flex-col gap-6 p-28 max-w-6xl mx-auto'>
        <h1 className='text-4xl font-bold text-blue-800'>Welcome to  <span className='text-red-600'>Morning Dispatch</span></h1>
        <p className='text-gray-600 mt-3 text-lg'> Your trusted source for the latest headlines, in-depth analysis, and breaking news every morning.</p>

        <p className='text-gray-500 mt-1 italic'>Stay informed, stay ahead</p>

        <Link to={"/search"}>
        <Button className="bg-yellow-400 hover:bg-yellow-600 text-black py-3 px-6 rounded-full font-semibold shadow-lg items-center gap-2 w-fit">View all posts <ArrowRight className='h-5 w-5' /></Button></Link>
      </div>
       <section className='pb-16 bg-white'>
        <div className='max-w-7xl mx-auto text-center'>
          <h2 className='text-4xl font-bold mb-8 text-gray-800'>Why You'll Love Morning Dispatch</h2>

          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <FeatureCard title={"Diverse Content"}
            description={
              "Explore news on a variety of topics, from technology to lifestyles."
            }
            icon={"📚"}
            />
