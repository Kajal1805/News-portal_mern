...
const Footer = () => {
    ...
    {/* About Section */}
     <div>
        ...
        <p className='text-gray-400 text-sm'> We are committed to providing the best service and information possible. Our mission is to enrich lives through exceptional digital experiences.</p>
     </div>
    ...
    <div>
        <h2 className='text-lg font-semibold mb-4'>Quick Links</h2>
          <ul className='space-y-2 text-gray-400'>
            ...
            <li><Link to="/NewsArticle" className='hover:text-white'>News Articles</Link></li>
